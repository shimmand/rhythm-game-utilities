    function main() {
        ...
        let insertHTML = [
            ...
            `    <span _ngcontent-custom-c3 class="stage-name">TETOCONNE CHART FILTER v0.50.01</span>`,
            ...
            `                <input type="radio" id="standard-under-s" name="input-filter" value="standard-under-s" onclick="applyFilter('standard', 700000);">`,
            `                <label for="standard-under-s">S未満</label>`,
            `                <input type="radio" id="standard-under-ss" name="input-filter" value="standard-under-ss" onclick="applyFilter('standard', 800000);">`,
            `                <label for="standard-under-ss">SS未満</label>`,
            `                <input type="radio" id="standard-under-ssplus" name="input-filter" value="standard-under-ssplus" onclick="applyFilter('standard', 900000);">`,
            `                <label for="standard-under-ssplus">SS+未満</label>`,
            `                <input type="radio" id="standard-under-ap" name="input-filter" value="standard-under-ap" onclick="applyFilter('standard', 1000000);">`,
            `                <label for="standard-under-ap">AP未満</label>`,
            `            </app-difficulty-name>`,
            `        </div>`,
            `        <div>`,
            `            <app-difficulty-name _ngcontent-custom-c3 id="difficulty1">`,
            `                <input type="radio" id="expert-under-s" name="input-filter" value="expert-under-s" onclick="applyFilter('expert', 800000);">`,
            `                <label for="expert-under-s">S未満</label>`,
            `                <input type="radio" id="expert-under-ss" name="input-filter" value="expert-under-ss" onclick="applyFilter('expert', 900000);">`,
            `                <label for="expert-under-ss">SS未満</label>`,
            `                <input type="radio" id="expert-under-ssplus" name="input-filter" value="expert-under-ssplus" onclick="applyFilter('expert', 950000);">`,
            `                <label for="expert-under-ssplus">SS+未満</label>`,
            `                <input type="radio" id="expert-under-ap" name="input-filter" value="expert-under-ap" onclick="applyFilter('expert', 1000000);">`,
            `                <label for="expert-under-ap">AP未満</label>`,
            `            </app-difficulty-name>`,
            `        </div>`,
            `        <div>`,
            `            <app-difficulty-name _ngcontent-custom-c3 id="difficulty2">`,
            `                <input type="radio" id="ultimate-under-s" name="input-filter" value="ultimate-under-s" onclick="applyFilter('ultimate', 900000);">`,
            `                <label for="ultimate-under-s">S未満</label>`,
            `                <input type="radio" id="ultimate-under-ss" name="input-filter" value="ultimate-under-ss" onclick="applyFilter('ultimate', 950000);">`,
            `                <label for="ultimate-under-ss">SS未満</label>`,
            `                <input type="radio" id="ultimate-under-ssplus" name="input-filter" value="ultimate-under-ssplus" onclick="applyFilter('ultimate', 975000);">`,
            `                <label for="ultimate-under-ssplus">SS+未満</label>`,
            `                <input type="radio" id="ultimate-under-ap" name="input-filter" value="ultimate-under-ap" onclick="applyFilter('ultimate', 1000000);">`,
            `                <label for="ultimate-under-ap">AP未満</label>`,
            `            </app-difficulty-name>`,
            `        </div>`,
            `        <div>`,
            `            <app-difficulty-name _ngcontent-custom-c3>`,
            `                <input type="radio" id="filter-none" name="input-filter" value="filter-none" onclick="applyFilter('ultimate', 1000001);" checked>`,
            ...
            `            <input type="radio" id="order-ascend" name="input-order" value="order-ascend" onclick="applySort(0);">`,
            `            <label for="order-ascend">昇順</label>`,
            `            <input type="radio" id="order-descend" name="input-order" value="order-descend" onclick="applySort(-1);">`,
            `            <label for="order-descend">降順</label>`,
            `            </app-difficulty-name>`,
            `        </div>`,
            `    </span>`,
            `</li>`
